...
- **Environment Variables Set**:
  - `USE_UAP=true` (enables memory system)
...
- **Environment Variables Set**:
  - `USE_UAP=false` (no memory, no patterns)
...
_Generated: 2026-03-12 | Harbor CLI version checked and confirmed working at /home/cogtek/.local/bin/harbor_
