...
npm uninstall -g universal-agent-memory
...
- **Documentation**: [GitHub README](https://github.com/DammianMiller/universal-agent-memory)
- **Issues**: [GitHub Issues](https://github.com/DammianMiller/universal-agent-memory/issues)
- **Discussions**: [GitHub Discussions](https://github.com/DammianMiller/universal-agent-memory/discussions)
