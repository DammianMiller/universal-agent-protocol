...
4. PLAN      -> create TODO list of steps
5. VALIDATE  -> review plan for gaps, security, feasibility
6. WORK      -> implement (ALWAYS use worktree)
7. REVIEW    -> self-review diff
8. TEST      -> completion gates pass
9. LEARN     -> store outcome
```
