...
describe('Context Compression', () => {
  ...
  it('should summarize memories', () => {
    const memories = [
      ...
      {
        content: 'Found issue with token validation',
...
describe('Context Budget', () => {
  ...
  it('should truncate when over budget', () => {
    ...
    const longContent = Array(800)
      .fill('This is realistic content that generates tokens')
      .join(' ');
