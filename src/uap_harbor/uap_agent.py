...
CATEGORY_KEYWORDS = {
    'git': ['git', '.git', 'commit', 'branch', 'reflog', 'fsck', 'recovery', 'leak', 'sanitize'],
    'compression': ['compress', 'decomp', 'encode', 'decoder', 'encoder', 'compressor', 'decompressor', 'codegolf', 'gzip', 'zlib'],
    'chess': ['chess', 'stockfish', 'fen', 'checkmate', 'best move', 'legal move'],
    'polyglot': ['polyglot', 'multi-language', 'compile in both', 'two languages'],
    'service': ['server', 'nginx', 'webserver', 'grpc', 'http service', 'listen on port', 'start a service', 'web server'],
    'competitive': ['corewars', 'warrior', 'pmars', 'redcode', 'win rate', 'opponent'],
    'statistics': ['mcmc', 'sampling', 'stan', 'pystan', 'rstan', 'ars', 'rejection sampler', 'bayesian', 'statistical'],
    'c_systems': ['segfault', 'buffer overflow', '.c file', 'compile c', 'gcc', 'makefile', 'cython', 'mips', 'assembly'],
    ...
    'ml_recovery': ['pytorch', 'torch', 'model recovery', 'corrupted model', 'state_dict', 'safetensors', 'hf model', 'huggingface'],
    'webserver': ['webserver', 'web server', 'git web', 'gitweb', 'instaweb', 'cgit', 'httpd', 'configure.*server'],
}
